...
export function Component() {
  return (
    (<div className="flex flex-col min-h-screen">
      <header
        className="flex items-center h-[60px] px-4 border-b bg-white md:px-6 dark:bg-gray-950">
      ...
      <main className="flex-1">
        <div
          className="mx-auto max-w-7xl grid gap-4 px-4 md:grid-cols-2 md:gap-8 md:px-6 lg:gap-12">
          <div
            className="flex flex-col items-center justify-center py-12 space-y-2 md:items-start md:space-y-4 md:py-16 md:space-y-0">
            <div className="grid gap-2">
              <h1
                className="text-3xl font-bold tracking-tighter md:text-5xl lg:text-6xl/none">Hi, I'm Emily</h1>
        ...
        <div
          className="mx-auto max-w-7xl grid divide-y divide-gray-200 dark:divide-gray-800">
          <div className="grid gap-4 p-4 md:grid-cols-2 md:gap-8 md:p-6">
            <div className="grid gap-2">
              <h2
                className="text-3xl font-bold tracking-tighter md:text-4xl lg:text-5xl/none">About Me</h2>
          ...
          <div className="grid gap-4 p-4 md:grid-cols-2 md:gap-8 md:p-6">
            <div className="grid gap-2">
              <h2
                className="text-3xl font-bold tracking-tighter md:text-4xl lg:text-5xl/none">My Work</h2>
          ...
          <div className="grid gap-4 p-4 md:grid-cols-2 md:gap-8 md:p-6">
            <div className="grid gap-2">
              <h2
                className="text-3xl font-bold tracking-tighter md:text-4xl lg:text-5xl/none">My Skills</h2>
          ...
          <div className="grid gap-4 p-4 md:grid-cols-2 md:gap-8 md:p-6">
            <div className="grid gap-2">
              <h2
                className="text-3xl font-bold tracking-tighter md:text-4xl lg:text-5xl/none">Contact Me</h2>
